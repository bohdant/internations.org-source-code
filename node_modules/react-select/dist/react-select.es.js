...
var MultiValue = function MultiValue(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(CrossIcon, { size: 14 })
    )
  );
};
  ...
  createClass(Select, [{
    ...
    value: function renderInput(id) {
      ...
      if (!isSearchable) {
        ...
        return React.createElement('div', { style: { height: this.inputHeight } });
      }
...
var StateManager = function (_Component) {
  ...
  createClass(StateManager, [{
    ...
    key: 'render',
    value: function render() {
      return React.createElement(Select$2, _extends({}, this.props, {
...
export { Select$2 as Base, createFilter, components, mergeStyles };
